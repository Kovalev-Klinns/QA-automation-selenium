...
public class GoogleCloudCalculatorPage extends AbstractPage {
    ...
    public String getResultVMClassText() {
    ...
    public String getResultRegionText() {
        return resultRegion.getText();
    }

    public String getResultLocalSSDText() {
        return resultLocalSSD.getText();
    }

    public String getResultCommitmentTermText() {
        return resultCommitmentTerm.getText();
    }

    public String getResultTotalEstimatedCostText() {
        return resultTotalEstimatedCost.getText();
    }
}
